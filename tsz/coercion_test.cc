...
TEST(CoercionTest, ParameterType) {
  ...
  EXPECT_TRUE((std::is_same_v<tsz::ParameterTypeT<signed char>, int64_t>));
  EXPECT_TRUE((std::is_same_v<tsz::ParameterTypeT<unsigned char>, int64_t>));
  EXPECT_TRUE((std::is_same_v<tsz::ParameterTypeT<signed short>, int64_t>));
  EXPECT_TRUE((std::is_same_v<tsz::ParameterTypeT<unsigned short>, int64_t>));
  EXPECT_TRUE((std::is_same_v<tsz::ParameterTypeT<signed int>, int64_t>));
  EXPECT_TRUE((std::is_same_v<tsz::ParameterTypeT<unsigned int>, int64_t>));
  EXPECT_TRUE((std::is_same_v<tsz::ParameterTypeT<signed long>, int64_t>));
  EXPECT_TRUE((std::is_same_v<tsz::ParameterTypeT<unsigned long>, int64_t>));
  EXPECT_TRUE((std::is_same_v<tsz::ParameterTypeT<signed long long>, int64_t>));
  EXPECT_TRUE((std::is_same_v<tsz::ParameterTypeT<unsigned long long>, int64_t>));
  EXPECT_TRUE((std::is_same_v<tsz::ParameterTypeT<float>, double>));
  EXPECT_TRUE((std::is_same_v<tsz::ParameterTypeT<double>, double>));
  EXPECT_TRUE((std::is_same_v<tsz::ParameterTypeT<long double>, double>));
