...
TEST(GeneratorTest, MakeHeaderFileName) {
  EXPECT_THAT(MakeHeaderFileName("foo", "bar.proto"), IsOkAndHolds("foo/bar.pb.h"));
  EXPECT_THAT(MakeHeaderFileName("bar", "foo.proto"), IsOkAndHolds("bar/foo.pb.h"));
  EXPECT_THAT(MakeHeaderFileName("foo", "bar.lorem"), StatusIs(absl::StatusCode::kInvalidArgument));
  EXPECT_THAT(MakeHeaderFileName("foo", "bar/baz.proto"), IsOkAndHolds("foo/baz.pb.h"));
  EXPECT_THAT(MakeHeaderFileName("bar", "foo/baz.proto"), IsOkAndHolds("bar/baz.pb.h"));
  EXPECT_THAT(MakeHeaderFileName("foo", "bar/baz.qux"),
              StatusIs(absl::StatusCode::kInvalidArgument));
  EXPECT_THAT(MakeHeaderFileName("foo", "bar/baz/qux.quux.proto"),
              IsOkAndHolds("foo/qux.quux.pb.h"));
}

TEST(GeneratorTest, MakeSourceFileName) {
  EXPECT_THAT(MakeSourceFileName("foo", "bar.proto"), IsOkAndHolds("foo/bar.pb.cc"));
  EXPECT_THAT(MakeSourceFileName("bar", "foo.proto"), IsOkAndHolds("bar/foo.pb.cc"));
  EXPECT_THAT(MakeSourceFileName("foo", "bar.lorem"), StatusIs(absl::StatusCode::kInvalidArgument));
  EXPECT_THAT(MakeSourceFileName("foo", "bar/baz.proto"), IsOkAndHolds("foo/baz.pb.cc"));
  EXPECT_THAT(MakeSourceFileName("bar", "foo/baz.proto"), IsOkAndHolds("bar/baz.pb.cc"));
  EXPECT_THAT(MakeSourceFileName("foo", "bar/baz.qux"),
              StatusIs(absl::StatusCode::kInvalidArgument));
  EXPECT_THAT(MakeSourceFileName("foo", "bar/baz/qux.quux.proto"),
              IsOkAndHolds("foo/qux.quux.pb.cc"));
}
