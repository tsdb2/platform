...
::absl::Status Tsdb2ProtoParse(::tsdb2::proto::text::Parser* const parser, Duration* const proto) {
  *proto = Duration();
...
::tsdb2::proto::MessageDescriptor<Duration, /*num_fields=*/2> const Duration::MESSAGE_DESCRIPTOR{{
