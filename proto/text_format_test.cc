...
//               StatusIs(absl::StatusCode::kFailedPrecondition));
//   EXPECT_THAT(Parse<OptionalField>("field: FOO"),
//   StatusIs(absl::StatusCode::kFailedPrecondition)); EXPECT_THAT(Parse<OptionalField>("field:
//   \"42\""),
//               StatusIs(absl::StatusCode::kFailedPrecondition));
//   EXPECT_THAT(Parse<OptionalField>("field: true"),
//   StatusIs(absl::StatusCode::kFailedPrecondition)); EXPECT_THAT(Parse<OptionalField>("lorem:
//   42"), IsOkAndHolds(OptionalField())); EXPECT_THAT(Parse<OptionalField>("field2: 42"),
//   IsOkAndHolds(OptionalField())); EXPECT_THAT(Parse<OptionalField>("field: 123"),
//   IsOkAndHolds(OptionalField{.field = 123}));
// }
...
//               StatusIs(absl::StatusCode::kFailedPrecondition));
//   EXPECT_THAT(Parse<DefaultedField>("field: FOO"),
//   StatusIs(absl::StatusCode::kFailedPrecondition)); EXPECT_THAT(Parse<DefaultedField>("field:
//   \"43\""),
//               StatusIs(absl::StatusCode::kFailedPrecondition));
...
//               StatusIs(absl::StatusCode::kFailedPrecondition));
//   EXPECT_THAT(Parse<RequiredField>("field: FOO"),
//   StatusIs(absl::StatusCode::kFailedPrecondition)); EXPECT_THAT(Parse<RequiredField>("field:
//   \"43\""),
//               StatusIs(absl::StatusCode::kFailedPrecondition));
//   EXPECT_THAT(Parse<RequiredField>("field: true"),
//   StatusIs(absl::StatusCode::kFailedPrecondition)); EXPECT_THAT(Parse<RequiredField>("field:
//   123"), IsOkAndHolds(RequiredField{.field = 123}));
// }
...
//               StatusIs(absl::StatusCode::kFailedPrecondition));
//   EXPECT_THAT(Parse<RepeatedField>("field: FOO"),
//   StatusIs(absl::StatusCode::kFailedPrecondition)); EXPECT_THAT(Parse<RepeatedField>("field:
//   \"43\""),
//               StatusIs(absl::StatusCode::kFailedPrecondition));
//   EXPECT_THAT(Parse<RepeatedField>("field: true"),
//   StatusIs(absl::StatusCode::kFailedPrecondition)); EXPECT_THAT(Parse<RepeatedField>("field: 56
//   field: 34 field: 12"),
...
//   StatusIs(absl::StatusCode::kInvalidArgument)); EXPECT_THAT(Parse<OptionalEnumField>("color:
//   \"COLOR_GREEN\""),
//               StatusIs(absl::StatusCode::kInvalidArgument));
...
//   IsOkAndHolds(OptionalEnumField())); EXPECT_THAT(Parse<OptionalEnumField>("color: COLOR_BLUE"),
...
//   StatusIs(absl::StatusCode::kInvalidArgument)); EXPECT_THAT(Parse<RequiredEnumField>("color:
//   \"COLOR_GREEN\""),
//               StatusIs(absl::StatusCode::kInvalidArgument));
...
//   StatusIs(absl::StatusCode::kInvalidArgument)); EXPECT_THAT(Parse<RepeatedEnumField>("color:
//   \"43\""),
//               StatusIs(absl::StatusCode::kInvalidArgument));
